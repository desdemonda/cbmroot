...
void run_sim_flow(Double_t En=10, Int_t nEvents = 2, Int_t fileNum = 5)  
{
  ...
  if (gen == 0)
  {
      ...
      TString inFile = "/hera/cbm/prod/gen/" + sGen + "/auau/" + sEn + "gev/mbias/urqmd.auau." + sEn + "gev.mbias." + sfileNumL +  ".root";
  }

  if (gen == 1)
  {
      // ASCII file for SHIELD, provided by Marina Golubeva
      TString inFile = "/hera/cbm/users/marina/" + sGen + "/au" + sEn + "au/evt/FOR038_au" + sEn + "au_100ev_" + sfileNum +  ".dat";
  }
