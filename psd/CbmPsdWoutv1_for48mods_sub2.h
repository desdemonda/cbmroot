...
#ifndef CBMPSDWOUTV1_FOR48MODS_SUB2_H
#define CBMPSDWOUTV1_FOR48MODS_SUB2_H
...
class CbmPsdWoutv1_for48mods_sub2 : public CbmPsd
{

 public:

  /** Default constructor **/
  CbmPsdWoutv1_for48mods_sub2();
   ...
   **/
  CbmPsdWoutv1_for48mods_sub2(const char* name, Bool_t active);


  /** Destructor **/
  virtual ~CbmPsdWoutv1_for48mods_sub2();
 ...
 private:
  ...
  ClassDef(CbmPsdWoutv1_for48mods_sub2,3)

};

inline void CbmPsdWoutv1_for48mods_sub2::ResetParameters() {
