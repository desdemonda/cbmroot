...
#ifndef CBMPSDV1_60MODS_HOLE6CM_H
#define CBMPSDV1_60MODS_HOLE6CM_H
...
class CbmPsdv1_60mods_hole6cm : public CbmPsd
{

 public:

  /** Default constructor **/
  CbmPsdv1_60mods_hole6cm();
   ...
   **/
  CbmPsdv1_60mods_hole6cm(const char* name, Bool_t active);


  /** Destructor **/
  virtual ~CbmPsdv1_60mods_hole6cm();
 ...
 private:
  ...
  ClassDef(CbmPsdv1_60mods_hole6cm,4)

};

inline void CbmPsdv1_60mods_hole6cm::ResetParameters() {
