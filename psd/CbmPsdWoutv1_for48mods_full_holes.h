...
#ifndef CBMPSDWOUTV1_FOR48MODS_FULL_HOLES_H
#define CBMPSDWOUTV1_FOR48MODS_FULL_HOLES_H
...
class CbmPsdWoutv1_for48mods_full_holes : public CbmPsd
{

 public:

  /** Default constructor **/
  CbmPsdWoutv1_for48mods_full_holes();
   ...
   **/
  CbmPsdWoutv1_for48mods_full_holes(const char* name, Bool_t active);


  /** Destructor **/
  virtual ~CbmPsdWoutv1_for48mods_full_holes();
 ...
 private:
  ...
  ClassDef(CbmPsdWoutv1_for48mods_full_holes,3)

};

inline void CbmPsdWoutv1_for48mods_full_holes::ResetParameters() {
